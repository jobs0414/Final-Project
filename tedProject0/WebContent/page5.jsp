...
<!-- 5 pie chart 그리기 -->
    ...
    <script type="text/javascript">
  	...
  	<button onclick="ajaxReq5()">파이차트 보기</button>
	<div id="piechart5_3d" style="width: 1000px; height: 600px;"></div>
    <button onclick="ajaxFun0('Environment')">워드클라우드 보기</button>
