...
<!-- 8 pie chart 그리기 -->
    ...
    <script type="text/javascript">
      ...
      function drawChart8(v) {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('piechart8_3d'));
    ...
    <script type="text/javascript">
  	...
  	<button onclick="ajaxReq8()">파이차트 보기</button>
	<div id="piechart8_3d" style="width: 1000px; height: 600px;"></div>
    <button onclick="ajaxFun0('Education')">워드클라우드 보기</button>
