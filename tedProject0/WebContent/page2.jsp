...
<!-- 2 pie chart 그리기 -->
    ...
    <script type="text/javascript">
  	...
  	<button onclick="ajaxReq2()">파이차트 보기</button>
	<div id="piechart2_3d" style="width: 1000px; height: 600px;"></div>
    <button onclick="ajaxFun0('Health_Medical')">워드클라우드 보기</button>
