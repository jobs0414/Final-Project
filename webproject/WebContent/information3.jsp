...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<font id="top" color="green" size="7"><b><strong>&nbsp;&nbsp;&nbsp;&nbsp;조회수 Top10 강연자 리스트 - Self-development</strong></b></font>
		<div id="accordion">
		<c:forEach items="${requestScope.infoShow}" var="data" varStatus="i">
			<article>
				<h2>Top ${i.count}</h2>
				<img src="img/Self-developmentTop10/${data.photo}.png" width="100" height="75">
				<ol type="1">
					<br><br><br><br><br>
					<li>이름 : </li>
					...
					<li><a href="${data.url}">TED 영상 링크</a></li>
						<br>
					<li><a href="${data.web_site}">강연자 정보 더보기</a></li>
				</ol>
			</article>
		</c:forEach>	
		</div>
