...
#info5{width:1500px; height:800px;}
...
<body onLoad="ajaxReq5();ajaxFun5('Environment');ajaxinfo5('Environment');">   
...
<div id="whole">
   ...
   <div class="wordCloud" style="width: 500px; height: 10px">
       ...
       function ajaxFun5(v){
        ...
        var svg = d3.select("svg").append("g").attr("transform", "translate(" + width / 2.8 + "," + height / 2 + ")");
