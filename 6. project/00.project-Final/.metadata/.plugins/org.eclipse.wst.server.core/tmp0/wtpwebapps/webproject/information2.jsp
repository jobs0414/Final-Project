...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<font id="top" color="green" size="7"><b><strong>&nbsp;&nbsp;&nbsp;&nbsp;조회수 Top10 강연자 리스트 - Health_Medical</strong></b></font>
		<div id="accordion">
		<c:forEach items="${requestScope.infoShow}" var="data" varStatus="i">
			<article>
				<h2>Top ${i.count}</h2>
				<img src="img/Health_MedicalTop10/${data.photo}.png" width="100" height="75">
				<ol type="1">
					<br><br><br><br><br>
					<li>이름 : </li>
